<template>
  <el-dialog v-model="dialogFormVisible" title="修改密码" :align-center="true">
    <el-form :model="form">
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button type="primary" @click="handelClick">确定</el-button>
      </span>
    </template>
  </el-dialog>
</template>
...
const emits=defineEmits(["modifyPassword","cancel"])
const cancel=()=>{
  emits("cancel")
}
const handelClick=()=>{
  emits("modifyPassword",form)
}
</script>
